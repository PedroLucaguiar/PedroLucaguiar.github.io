...
const galleryItems = [
  ...
  { id: 4, aspect: 'video', label: 'Domm Hive', image: '/projects/sites/2/1.webp', url: 'https://baiani-dev.github.io/DOMMHIVE/' },
  { id: 5, aspect: 'video', label: 'Domm Hive', image: '/projects/sites/2/2.webp', url: 'https://baiani-dev.github.io/DOMMHIVE/' },
  { id: 6, aspect: 'video', label: 'Domm Hive', image: '/projects/sites/2/3.webp', url: 'https://baiani-dev.github.io/DOMMHIVE/' },
  ...
  { id: 13, aspect: 'video', label: 'NXOS Hub', image: '/projects/hub/1.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 14, aspect: 'video', label: 'NXOS Hub', image: '/projects/hub/2.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 15, aspect: 'video', label: 'NXOS Hub', image: '/projects/hub/3.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 16, aspect: 'video', label: 'PeopleSync', image: '/projects/rh/peoplesync-policies.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 17, aspect: 'video', label: 'PeopleSync', image: '/projects/rh/peoplesync-calendar.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 18, aspect: 'video', label: 'PeopleSync', image: '/projects/rh/3.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 19, aspect: 'video', label: 'FieldOps', image: '/projects/fieldops/report-team.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 20, aspect: 'video', label: 'FieldOps', image: '/projects/fieldops/2.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 21, aspect: 'video', label: 'FieldOps', image: '/projects/fieldops/schedule-rule.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 22, aspect: 'video', label: 'Medição MR', image: '/projects/medicao/calendar-safe.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 23, aspect: 'video', label: 'Medição MR', image: '/projects/medicao/bm-config-safe.webp', url: 'https://hub-dev.nxosbr.com/login/' },
  { id: 24, aspect: 'video', label: 'Medição MR', image: '/projects/medicao/3.webp', url: 'https://hub-dev.nxosbr.com/login/' },
